...
android {
    namespace = "com.pankajsharma.smart_pulchowk"
    ...
    defaultConfig {
        applicationId = "com.pankajsharma.smart_pulchowk"
    ...
    buildTypes {
        release {
            ...
            // Keep resources referenced dynamically at runtime (notification icons/channels).
